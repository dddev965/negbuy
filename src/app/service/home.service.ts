...
export class HomeService {
  ...
  sendPostRequest(payload = { category: 'Hardware', number: 20 }) {
    ...
    return this.http.post<any>(
      'https://test.negbuy.com/api/homepage_single_category_products',
  ...
  brand(payload = { choice: 'brand' }) {
    ...
    // Send the POST request with the JSON payload and headers
    return this.http.post<any>(
      'https://test.negbuy.com/api/homepage_posters_brands',
      payloadString,
      { headers: headers }
    );
  }
  ...
  product(payload = { product_id: 107 }) {
    ...
    // Send the POST request with the JSON payload and headers
    return this.http.post<any>(
      'https://test.negbuy.com/api/product_details_page',
      payloadString,
      { headers: headers }
    );
  }
